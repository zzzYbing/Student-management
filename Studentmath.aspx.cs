...
public partial class Studentmath : System.Web.UI.Page
{
    ...
    private void DeleteRow(int 学号)
    {
        ...
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString))
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.CommandText = "DELETE FROM Studentsmath WHERE 学号=@学号";
    ...
    private DataTable GetData()
    {
        ...
        using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString))
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.Connection = con;
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = "SELECT * FROM Studentsmath";
                // 创建SqlDataAdapter对象
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        SqlDataSource1.SelectCommand = "SELECT * FROM [Studentsmath] WHERE [学号] = @StudentNumber";
