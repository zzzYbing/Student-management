<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Scocom.aspx.cs" Inherits="Scocom" %>
        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td rowspan="7" class="auto-style23" colspan="2">
                    <span class="auto-style38">计算机专业学生成绩信息</span><br />
                    ...
                    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="学号" DataSourceID="SqlDataSource1" CssClass="auto-style39">
                        <Columns>
                            ...
                            <asp:BoundField DataField="数据结构" HeaderText="数据结构" SortExpression="数据结构" ItemStyle-Width="80px"/>
                            <asp:BoundField DataField="操作系统" HeaderText="操作系统" SortExpression="操作系统" ItemStyle-Width="80px"/>
                            <asp:BoundField DataField="计算机网络" HeaderText="计算机网络" SortExpression="计算机网络" ItemStyle-Width="80px"/>
                            <asp:BoundField DataField="计算机组成原理" HeaderText="计算机组成原理" SortExpression="计算机组成原理" ItemStyle-Width="160px"/>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [学号], [姓名], [专业], [数据结构], [操作系统], [计算机网络], [计算机组成原理], [总成绩] FROM [Studentscomputer]" DeleteCommand="DELETE FROM Studentscomputer WHERE 学号=@学号"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
