<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Studentcom.aspx.cs" Inherits="Studentcom" %>
        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td rowspan="7" class="auto-style23" colspan="2">
                    <span class="auto-style38">计算机专业学生基本信息</span><br />
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="学号" DataSourceID="SqlDataSource1" AllowPaging="True" CssClass="auto-style39">
                        <Columns>
                            ...
                            <asp:BoundField DataField="性别" HeaderText="性别" SortExpression="性别" ItemStyle-Width="80px" />
                            <asp:BoundField DataField="年龄" HeaderText="年龄" SortExpression="年龄" ItemStyle-Width="80px" />
                            <asp:BoundField DataField="出生日期" HeaderText="出生日期" SortExpression="出生日期" DataFormatString="{0:yyyy-MM-dd}" ItemStyle-Width="150px"  />
                            <asp:BoundField DataField="家庭住址" HeaderText="家庭住址" SortExpression="家庭住址" ItemStyle-Width="200px" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM Studentscomputer WHERE 学号=@学号" SelectCommand="SELECT [学号], [姓名], [专业], [性别], [年龄], [出生日期], [家庭住址] FROM [Studentscomputer]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
