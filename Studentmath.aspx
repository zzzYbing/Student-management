<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Studentmath.aspx.cs" Inherits="Studentmath" %>
        ...
        <table class="auto-style2">
            ...
            <tr>
                ...
                <td rowspan="7" class="auto-style23" colspan="2" >
                    <span class="auto-style39">数学专业学生基本信息</span><br />
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="学号" DataSourceID="SqlDataSource1" AllowPaging="True" CssClass="auto-style38">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" DeleteCommand="DELETE FROM Studentsmath WHERE 学号=@学号" SelectCommand="SELECT [学号], [姓名], [专业], [性别], [年龄], [出生日期], [家庭住址] FROM [Studentsmath]"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
