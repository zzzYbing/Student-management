...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-container" >
            ...
            <table>
                <tr>
                    <th class="auto-style13" colspan="2">学生基本信息</th>
                </tr>
                <tr>
            ...
            <asp:Button type="submit" ID="Button1" runat="server" Text="继续" OnClick="Button1_Click" />
            
            <asp:Panel ID="Panel1" runat="server" Visible="false">
                <table >
                    <tr>
                        <th class="auto-style13" colspan="2">学生成绩信息</th>
                    </tr>
                    <tr>
                        <td class="auto-style1">
                            <br />
            ...
            <asp:Button ID="Button3" runat="server" Text="添加" Visible="false" OnClick="Button3_Click" />
        </div>
    </form>
</body>
</html>
